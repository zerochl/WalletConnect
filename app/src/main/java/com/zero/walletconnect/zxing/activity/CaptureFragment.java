package com.zero.walletconnect.zxing.activity;
...
import com.zero.walletconnect.zxing.decoding.CaptureActivityHandler;
import com.zero.walletconnect.zxing.decoding.InactivityTimer;
import com.zero.walletconnect.zxing.view.ViewfinderView;
...
//        characterSet = null;
    ...
    public void onPause() {
        super.onPause();
        HandlerManager.getInstance().postSlow(() -> {
            if (handler != null) {
